    ...
    <section id='about' className='px-5 sm:px-10 py-10'>
      <div className='grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6'>
        ...
        <div className='w-full h-full border border-gray-700 bg-black-200 rounded-lg p-4 sm:p-7 flex flex-col gap-5'>
          ...
          <p className='text-[#afb0b6] text-base font-generalsans'> HTML, CSS, JavaScript, React.js, Tailwind CSS, Three.js, Node.js, Express.js, MongoDB, Git & GitHub, C++, Python, OpenGL, GLSL, GLM,arch Linux user , Vercel,runway,davinci, Responsive Design</p>
        </div>
